...
def main():
    ...
    parser.add_argument('--checkpoint_dir', type=str, default = './checkpoint', help='directory to save checkpoint')
    parser.add_argument('--save_test_dir', type=str, default = './result', help='directory to save test submission file')
